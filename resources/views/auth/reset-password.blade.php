                                    ...
                                    <div class="p-3">
                                        ...
                                        <form method="POST" action="{{ route('password.update') }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="reset-email" type="email" name="email"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" id="reset-password-confirmation"
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="flex-fill text-center">
                                            ...
                                            <p class="mb-0 text-muted fw-normal fs-12">Enter your new password to
                                                continue.</p>
                                        </div>
