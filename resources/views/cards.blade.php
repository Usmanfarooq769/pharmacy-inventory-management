                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="../assets/images/media/media-18.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="../assets/images/media/media-20.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <h6 class="card-title fw-medium">Card title</h6>
                        ...
                        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            <div class="card custom-card">
                                <img src="../assets/images/media/media-19.jpg" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <p class="card-text">Some quick example text to build on the card title and
                                        make up the bulk of the card's content.</p>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <img src="../assets/images/media/media-7.jpg" class="card-img mb-3" alt="...">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-12">
                            ...
                            <div class="row row-cols-12">
                                <div class="col">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <img src="../assets/images/media/media-22.jpg" class="card-img mb-3" alt="...">
