                            ...
                            <div class="row mx-0 align-items-center">
                                <div class="col-xl-6">
                                    <div class="p-3">
                                        ...
                                        <div class="text-center">
                                            <p class="text-muted mt-3 mb-0">Back to home ? <a class="text-primary fw-medium text-decoration-underline" href="index.html">Click Here</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 border rounded bg-secondary-transparent border-secondary border-opacity-10">
                                    <div class="d-flex align-items-center justify-content-around flex-column gap-4 h-100">
                                        <img src="../assets/images/authentication/5.png" alt="Create Password" class="img-fluid m-auto mb-3 flex-fill mt-4">
                                        ...
                                        <a href="index.html"><img alt="logo" class="toggle-logo mb-4 pb-2" src="../assets/images/brand-logos/toggle-logo.png"></a>
                                    </div>
                                </div>                                
                            </div>
                        </div>
