                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-primary-transparent">
                                                                <img src="../assets/images/faces/1.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/11.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-secondary-transparent">
                                                                <img src="../assets/images/faces/11.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/5.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-success-transparent">
                                                                <img src="../assets/images/faces/16.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/6.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-info-transparent">
                                                                <img src="../assets/images/faces/14.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/15.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-warning-transparent">
                                                                <img src="../assets/images/faces/12.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/13.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-pink-transparent">
                                                                <img src="../assets/images/faces/10.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-success-transparent">
                                                                <img src="../assets/images/faces/8.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/9.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-primary-transparent">
                                                                <img src="../assets/images/faces/5.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-sm bg-light avatar-rounded p-1">
                                                                <img src="../assets/images/company-logos/2.png" alt="Company Logo">
                                                            </span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/3.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr class="crm-contact leads-list">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-md p-1 bg-secondary-transparent">
                                                                <img src="../assets/images/faces/6.jpg" alt="Lead Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-sm bg-light avatar-rounded p-1">
                                                                <img src="../assets/images/company-logos/3.png" alt="Company Logo">
                                                            </span>
                                                        </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="lh-1">
                                                            <span class="avatar avatar-rounded avatar-sm">
                                                                <img src="../assets/images/faces/7.jpg" alt="Assigned Avatar">
                                                            </span>
                                                        </div>
                                                        <div>
