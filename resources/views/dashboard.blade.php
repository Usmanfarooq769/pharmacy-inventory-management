                            ...
                            <div class="col-xl-3">
                                <div class="card custom-card profit-analysis-card">
                                    <div class="card-body p-0">
                                        <div class="p-4 pb-1"> 
                                            <h4 class="mb-1 d-flex align-items-center fw-semibold flex-wrap"> {{ number_format($totalProfit, 2) }} Rs<span class="text-success fw-medium fs-12 ms-2"><i class="ti ti-arrow-up align-middle me-1"></i>0.25%</span> </h4> 
                                    ...
                                    <div class="card-body text-center p-0">
                                        ...
                                        <div class="row justify-content-center mt-4 p-3 gx-xl-1 gx-xxl-3">
                                            <div class="col col-xl-4 border-end border-inline-end-dashed">
                                                ...
                                                <span class="fw-semibold h6 mb-0 text-center">{{ number_format($todayRevenue, 2) }} Rs<i class="ti ti-arrow-up text-success"></i></span>
                                            </div>
                                            <div class="col col-xl-4 border-end border-inline-end-dashed">
                                                <span class="d-block text-muted mb-1 fs-12">Target</span>
                                                <span class="fw-semibold h6 mb-0 text-center">{{ number_format($target, 2) }}Rs<i class="ti ti-arrow-down text-danger"></i></span>
                                            </div>
                                            <div class="col col-xl-4">
                                                <span class="d-block text-muted mb-1 fs-12">This Year</span>
                                                <span class="fw-semibold h6 mb-0 text-center">{{ number_format($yearRevenue, 2) }}Rs<i class="ti ti-arrow-up text-success"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="d-flex align-items-center gap-3">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md bg-light">
                                                        ...
                                                        @else
                                                            <img src="{{ asset('assets/images/default-product.png') }}" alt="{{ $product->name }}">
                                                        @endif
                                                    </span>
                                                </div>
                                                <div class="flex-fill">
...
<script>
  ...
  var chart = new ApexCharts(document.querySelector("#sales-statistics-dash"), options);
  chart.render();
</script>
...
<script>
    ...
    var chart1 = new ApexCharts(document.querySelector("#revenue-statistics-dash"), options1);
    chart1.render();
</script>
