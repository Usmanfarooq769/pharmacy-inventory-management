                    ...
                    <div class="col-xl-10">
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-lg-3 col-sm-6">
                                <a href="../assets/images/media/media-40.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                    <img src="../assets/images/media/media-40.jpg" alt="image" >
                                </a>
                                <a href="../assets/images/media/media-36.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                    <img src="../assets/images/media/media-36.jpg" alt="image" >
                                </a>
                                <a href="../assets/images/media/media-47.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                    <img src="../assets/images/media/media-47.jpg" alt="image" >
                                </a>
                            </div>
                            <div class="col-lg-4 col-sm-6">
                                <a href="../assets/images/media/media-30.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                    <img src="../assets/images/media/media-30.jpg" alt="image" >
                                </a>
                                <a href="../assets/images/media/media-65.png" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                    <img src="../assets/images/media/media-65.png" alt="image" >
                                </a>
                                <a href="../assets/images/media/media-24.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                    <img src="../assets/images/media/media-24.jpg" alt="image" >
                                </a>
                            </div>
                            <div class="col-lg-5 d-none d-lg-block">
                                <div class="row gx-2 gy-0">
                                    ...
                                    <div class="col-lg-4">
                                        <a href="../assets/images/media/media-34.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                            <img src="../assets/images/media/media-34.jpg" alt="image" >
                                        </a>
                                    </div>
                                    <div class="col-lg-4">
                                        <a href="../assets/images/media/media-34.jpg" class="glightbox card custom-card mb-2" data-gallery="gallery1">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <div class="card custom-card overflow-hidden gallery-cards animate-fade">
                                                        <a href="../assets/images/media/media-40.jpg" class="glightbox stretched-link" data-gallery="gallery1">
                                                            <img src="../assets/images/media/media-40.jpg" alt="image" class="img-fluid gallery-tab-img">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-7">
                                            <div class="row">
                                                <div class="col-lg-6 col-6">
                                                    <div class="card custom-card overflow-hidden gallery-cards animate-fade">
                                                        <a href="../assets/images/media/media-30.jpg" class="glightbox stretched-link" data-gallery="gallery1">
                                                            <img src="../assets/images/media/media-30.jpg" alt="image" class="img-fluid gallery-tab-img">
                                                            <div class="gallery-desc p-3 text-fixed-white fw-medium">
                                                                Lorem Ipsum is simply dummy text of the printing
                                                            </div>
                                                        </a>
                                        ...
                                        <div class="col-lg-5 col-auto">
                                            <div class="card custom-card overflow-hidden gallery-cards animate-fade">
                                                <a href="../assets/images/media/media-64.jpg" class="glightbox stretched-link" data-gallery="gallery1">
                                                    <img src="../assets/images/media/media-64.jpg" alt="image" class="img-fluid gallery-tab-img">
                                                    <div class="gallery-desc p-3 text-fixed-white fw-medium">
                                                        Lorem Ipsum is simply dummy text of the printing
                                                    </div>
                                                </a>
