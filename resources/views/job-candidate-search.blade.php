                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-2 mb-2">
                                            <span class="avatar avatar-lg bg-light shadow-sm border border-primary border-opacity-10 p-1 avatar-rounded">
                                                <img src="../assets/images/faces/2.jpg" alt="Profile Picture">
                                            </span>
                                            <div class="ms-2">
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-2 mb-2">
                                            <span class="avatar avatar-lg bg-light shadow-sm border border-primary border-opacity-10 p-1 avatar-rounded">
                                                <img src="../assets/images/faces/5.jpg" alt="Profile Picture">
                                            </span>
                                            <div class="ms-2">
                                                <h6 class="fw-medium mb-1 d-flex align-items-center">
                                                    Emily Johnson
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-2 mb-2">
                                            <span class="avatar avatar-lg bg-light shadow-sm border border-primary border-opacity-10 p-1 avatar-rounded">
                                                <img src="../assets/images/faces/6.jpg" alt="Profile Picture">
                                            </span>
                                            <div class="ms-2">
                                                <h6 class="fw-medium mb-1 d-flex align-items-center">
                                                    Alex Martinez
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start flex-wrap gap-2 mb-2">
                                            <span class="avatar avatar-lg bg-light shadow-sm border border-primary border-opacity-10 p-1 avatar-rounded">
                                                <img src="../assets/images/faces/8.jpg" alt="Profile Picture">
                                            </span>
                                            <div class="ms-2">
                                                <h6 class="fw-medium mb-1 d-flex align-items-center">
                                                    Emily Clark
