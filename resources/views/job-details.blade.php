                            ...
                            <div class="card-body">
                                <div class="d-flex gap-3 flex-wrap">
                                    <div class="adds-card rounded-3 overflow-hidden flex-shrink-0">
                                        <img src="../assets/images/media/media-88.jpg" alt="" class="img-fluid">
                                    </div>
                                    <div class="flex-fill">
                                        ...
                                        <div class="d-flex mt-3 align-items-start gap-2 flex-wrap">
                                            ...
                                            <div>
                                                ...
                                                <div class="popular-tags mt-3 d-flex gap-1 flex-wrap">
                                                    <span class="badge rounded-pill bg-info fs-11"><i class="ti ti-clock-hour-8 me-1"></i>Full Time</span>
                                                    <span class="badge rounded-pill bg-secondary fs-11"><i class="ti ti-briefcase me-1"></i>8 Openings</span>
                                                    <span class="badge rounded-pill bg-success fs-11"><i class="ti ti-building-skyscraper me-1"></i>Onsite</span>
                                                </div>
                                            </div>
