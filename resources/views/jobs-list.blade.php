...
<body>
                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-header justify-content-between">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    ...
                                    <a href="job-post.html" class="btn btn-success btn-wave btn-sm">
                                    ...
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tbody>
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">Senior Frontend Developer</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-info-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/8.png" alt="Tech Innovations Inc.">
                                                        </span>
                                            ...
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">Backend Developer</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-secondary-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/9.png" alt="NextGen Solutions">
                                                        </span>
                                            ...
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">Full Stack Developer</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-success-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/10.png" alt="Innovate Solutions">
                                                        </span>
                                            ...
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">UI/UX Designer</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-primary-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/6.png" alt="Creative Minds">
                                                        </span>
                                            ...
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">DevOps Engineer</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-warning-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/1.png" alt="Tech Savvy">
                                                        </span>
                                            ...
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">Data Scientist</a></p>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-pink-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/3.png" alt="DataPro Analytics">
                                                        </span>
                                            ...
                                            <tr class="joblist-list">
                                                ...
                                                <td>
                                                    <p class="fw-medium mb-0 d-flex align-items-center"><a href="job-details.html">Mobile App Developer</a></p>
                                                    <span class="fs-12 text-muted"><i class="ri-pushpin-line"></i> Denver, CO</span>
                                                </td>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-sm p-1 me-1 bg-primary-transparent avatar-rounded">
                                                            <img src="../assets/images/company-logos/4.png" alt="AppFusion Technologies">
                                                        </span>
    ...
    <!-- Job list JS -->
    <script src="../assets/js/job-list.js"></script>
