...
<body>
                                ...
                                <div class="swiper swiper-preview-details bg-light product-details-page">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" id="img-container">
                                            <img class="img-fluid" src="../assets/images/nft-images/3.png" alt="img">
                                        </div>
                                        <div class="swiper-slide image-container">
                                            <img class="img-fluid" src="../assets/images/nft-images/4.png" alt="img">
                                        </div>
                                        <div class="swiper-slide image-container">
                                            <img class="img-fluid" src="../assets/images/nft-images/5.png" alt="img">
                                        </div>
                                        <div class="swiper-slide image-container">
                                            <img class="img-fluid" src="../assets/images/nft-images/6.png" alt="img">
                                        </div>
                                    </div>
                                                ...
                                                <div class="d-flex align-items-center gap-xxl-5 gap-3 mb-3 justify-content-between flex-wrap">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-items-center fw-medium gap-1">
                                                            <span class="avatar avatar-xs avatar-rounded lh-1"><img src="../assets/images/nft-images/2.png" alt=""></span>
                                                            Landscapes NFT 
                                                        </div>
                                                    </div>
                                                    <div>
                                                    ...
                                                    <div class="me-3">
                                                        ...
                                                        <div class="d-flex align-items-center fw-medium gap-1">
                                                            <span class="avatar avatar-xs avatar-rounded lh-1"><img src="../assets/images/faces/9.jpg" alt=""></span>
                                                            Christopher 
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <tbody>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex gap-1 align-items-center">
                                                        <span class="avatar avatar-xs avatar-rounded lh-1">
                                                            <img src="../assets/images/faces/9.jpg" alt=""></span>By Ananth
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="justify-content-center d-flex gap-2">
                                                        <p class="mb-0 fs-19 fw-medium">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>2.299 ETH
                                                        </p>
                                                        <p class="mb-0 text-muted">
                                                            (<s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>3.299 ETH</s>)
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex gap-1 align-items-center">
                                                        <span class="avatar avatar-xs avatar-rounded lh-1">
                                                            <img src="../assets/images/faces/10.jpg" alt=""></span>By Maya
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="justify-content-center d-flex gap-2">
                                                        <p class="mb-0 fs-19 fw-medium">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>1.875 ETH
                                                        </p>
                                                        <p class="mb-0 text-muted">
                                                            (<s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>2.500 ETH</s>)
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex gap-1 align-items-center">
                                                        <span class="avatar avatar-xs avatar-rounded lh-1">
                                                            <img src="../assets/images/faces/11.jpg" alt=""></span>By Leo
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="justify-content-center d-flex gap-2">
                                                        <p class="mb-0 fs-19 fw-medium">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>3.150 ETH
                                                        </p>
                                                        <p class="mb-0 text-muted">
                                                            (<s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>4.000 ETH</s>)
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex gap-1 align-items-center">
                                                        <span class="avatar avatar-xs avatar-rounded lh-1">
                                                            <img src="../assets/images/faces/12.jpg" alt=""></span>By Sarah
                                                    </div>
                                                </td>
                                                <td class="text-center">
                                                ...
                                                <td>
                                                    <div class="justify-content-center d-flex gap-2">
                                                        <p class="mb-0 fs-19 fw-medium">
                                                            <span class="avatar avatar-xs avatar-rounded"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>4.800 ETH
                                                        </p>
                                                        <p class="mb-0 text-muted">
                                                            (<s><span class="avatar avatar-xs avatar-rounded p-1"><img src="../assets/images/crypto-currencies/regular/Ethereum.svg" alt=""></span>5.500 ETH</s>)
                                                        </p>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="card custom-card">
                                    <div class="card-body">
                                        ...
                                        <div class="position-relative overflow-hidden rounded">
                                            <img src="../assets/images/nft-images/2.png" class="card-img mb-3" alt="...">
                                        </div>
                            ...
                            <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                        <a href="javascript:void(0);" class="stretched-link"></a>
                                        <div class="position-relative overflow-hidden rounded">
                                            <img src="../assets/images/nft-images/4.png" class="card-img mb-3" alt="...">
                                        </div>
                                        <div class="d-flex align-items-start gap-2 mb-2 pb-1 flex-wrap">
                                            <div class="text-truncate">
    ...
    <script src="../assets/js/nft-details.js"></script>
