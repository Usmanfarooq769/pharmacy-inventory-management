...
<body>
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded me-2">
                                                        <img src="../assets/images/nft-images/1.png" alt="Mystic Forest" class="nft-image">
                                                    </span>
                                                </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded me-2">
                                                        <img src="../assets/images/nft-images/2.png" alt="Digital Dreams" class="nft-image">
                                                    </span>
                                                </div>
                                                <div class="align-items-center">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded me-2">
                                                        <img src="../assets/images/nft-images/3.png" alt="Pixelated Glory" class="nft-image">
                                                    </span>
                                                </div>
                                                <div class="align-items-center">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded me-2">
                                                        <img src="../assets/images/nft-images/4.png" alt="Galactic Voyage" class="nft-image">
                                                    </span>
                                                </div>
                                                <div class="align-items-center">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded me-2">
                                                        <img src="../assets/images/nft-images/5.png" alt="Cyber Samurai" class="nft-image">
                                                    </span>
                                                </div>
                                                <div class="align-items-center">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                            <div class="d-flex align-items-center">
                                                <div class="lh-1">
                                                    <span class="avatar avatar-md avatar-rounded me-2">
                                                        <img src="../assets/images/nft-images/6.png" alt="Ethereal Realm" class="nft-image">
                                                    </span>
                                                </div>
                                                <div class="align-items-center">
                                ...
                                <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <a href="javascript:void(0);" class=""></a>
                                            <div class="position-relative overflow-hidden rounded">
                                                <img src="../assets/images/nft-images/6.png" class="card-img mb-3" alt="...">
                                            </div>
                                            <div class="d-flex align-items-start gap-2 mb-2 pb-1 flex-wrap">
                                                <div class="text-truncate">
                                                    <p class="fs-16 mb-0 fw-semibold text-truncate">Abstract Digital Art</p>
    ...
    <!-- Live Auction JS -->
    <script src="../assets/js/live-auction.js"></script>
