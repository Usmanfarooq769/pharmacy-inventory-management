                                        ...
                                        <div class="card custom-card nft-wallet mb-xxl-0">
                                            <div class="card-body py-1 px-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-rounded p-1 bg-primary-transparent">
                                                            <img src="../assets/images/nft-images/35.png" alt="Phantom Wallet">
                                                        </span>
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="card custom-card nft-wallet mb-xxl-0">
                                            <div class="card-body py-1 px-2">
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-rounded p-1 bg-primary-transparent">
                                                            <img src="../assets/images/nft-images/37.png" alt="Ledger Live">
                                                        </span>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="tab-pane overflow-hidden p-0 border-0" id="YourNFTpane" role="tabpanel" aria-labelledby="YourNFT" tabindex="1">
                                                <div class="row g-2">
                                                    <div class="col-xxl-3 col-6">
                                                        <img src="../assets/images/nft-images/2.png" class="card-img" alt="...">
                                                    </div>
                                                    <div class="col-xxl-3 col-6">
                                                        <img src="../assets/images/nft-images/1.png" class="card-img" alt="...">
                                                    </div>
                                                    <div class="col-xxl-3 col-6">
                                                        <img src="../assets/images/nft-images/3.png" class="card-img" alt="...">
                                                    </div>
                                                    <div class="col-xxl-3 col-6">
                                                        <img src="../assets/images/nft-images/4.png" class="card-img" alt="...">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
