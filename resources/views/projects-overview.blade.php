                                    ...
                                    <li class="mb-3 bg-light p-3">
                                        <div class="d-flex gap-2 flex-wrap">
                                            <span class="avatar avatar-sm shadow-sm bg-success avatar-rounded flex-shrink-0">
                                                <img src="../assets/images/faces/1.jpg" alt="Sarah Johnson">
                                            </span>
                                    ...
                                    <li class="mb-3 p-3">
                                        <div class="d-flex gap-2 flex-wrap">
                                            <span class="avatar avatar-sm shadow-sm bg-info avatar-rounded flex-shrink-0">
                                                <img src="../assets/images/faces/14.jpg" alt="David Smith">
                                            </span>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start gap-2 mb-2 flex-wrap">
                                                    <div class="fw-medium">
                                    ...
                                    <li class="mb-3 bg-light p-3">
                                        <div class="d-flex gap-2 flex-wrap">
                                            <span class="avatar avatar-sm shadow-sm bg-warning avatar-rounded flex-shrink-0">
                                                <img src="../assets/images/faces/3.jpg" alt="Emily Davis">
                                            </span>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start gap-2 mb-2 flex-wrap">
                                                    <div class="fw-medium">
                                    ...
                                    <li class="mb-3 p-3">
                                        <div class="d-flex gap-2 flex-wrap">
                                            <span class="avatar avatar-sm shadow-sm bg-danger avatar-rounded flex-shrink-0">
                                                <img src="../assets/images/faces/16.jpg" alt="Michael Brown">
                                            </span>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start gap-2 mb-2 flex-wrap">
                                                    <div class="fw-medium">
                                    ...
                                    <li class="bg-light p-3">
                                        <div class="d-flex gap-2 flex-wrap">
                                            <span class="avatar avatar-sm shadow-sm bg-secondary avatar-rounded flex-shrink-0">
                                                <img src="../assets/images/faces/6.jpg" alt="Jessica Green">
                                            </span>
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start gap-2 mb-2 flex-wrap">
                                                    <div class="fw-medium">
                            ...
                            <div class="card-footer">
                                <div class="d-sm-flex align-items-center lh-1">
                                    <div class="me-sm-2 mb-2 mb-sm-0 rounded-circle bg-primary-transparent d-inline-block">
                                        <img src="../assets/images/faces/5.jpg" alt="" class="avatar avatar-md avatar-rounded p-1 bg-primary-transparent">
                                    </div>
                                    <div class="flex-fill">
                        ...
                        <div class="card custom-card overflow-hidden">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="d-flex gap-2 align-items-center">
                                        <span class="avatar avatar-md shadow-sm bg-primary avatar-rounded flex-shrink-0">
                                            <img src="../assets/images/faces/11.jpg" alt="John Doe">
                                        </span>
                                        <div class="flex-grow-1">
                                ...
                                <div class="mb-3">
                                    <div class="d-flex gap-2 align-items-center">
                                        <span class="avatar avatar-md shadow-sm bg-primary avatar-rounded flex-shrink-0">
                                            <img src="../assets/images/faces/2.jpg" alt="Jane Smith">
                                        </span>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <div class="fw-medium">
                                ...
                                <div class="mb-3">
                                    <div class="d-flex gap-2 align-items-center">
                                        <span class="avatar avatar-md shadow-sm bg-primary avatar-rounded flex-shrink-0">
                                            <img src="../assets/images/faces/8.jpg" alt="Emily Johnson">
                                        </span>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <div class="fw-medium">
                                ...
                                <div class="mb-4">
                                    <div class="d-flex gap-2 align-items-center">
                                        <span class="avatar avatar-md shadow-sm bg-primary avatar-rounded flex-shrink-0">
                                            <img src="../assets/images/faces/12.jpg" alt="Michael Brown">
                                        </span>
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-start gap-2">
                                                <div class="fw-medium">
                                ...
                                <div class="btn btn-primary-light w-100">Invite New Member</div>
                            </div>
                        </div>
                    </div>
                </div>
