                            ...
                            <div class="row mx-0 align-items-center">
                                <div class="col-xl-6">
                                    <div class="p-3">
                                        ...
                                        <div class="d-grid mt-4">
                                            <a href="index.html" class="btn btn-primary"><i class="ri-lock-2-line lh-1 me-2 align-middle"></i>Reset Password</a>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-muted mt-3 mb-0">Want to go back? <a class="text-primary fw-medium text-decoration-underline" href="index.html">Click here</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 border rounded bg-secondary-transparent border-secondary border-opacity-10">
                                    <div class="d-flex align-items-center justify-content-around flex-column gap-4 h-100">
                                        <img src="../assets/images/authentication/5.png" alt="Reset Password" class="img-fluid m-auto mb-3 flex-fill mt-4">
