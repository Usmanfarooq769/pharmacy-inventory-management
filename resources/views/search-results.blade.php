                                                ...
                                                <div class="d-flex align-items-start justify-content-between flex-wrap gap-1 mb-3">
                                                    <div class="d-flex gap-2 align-items-start flex-wrap">
                                                        <span class="avatar avatar-lg avatar-rounded bg-primary-transparent p-2">
                                                            <img src="../assets/images/company-logos/1.png" alt="Modern Admin Logo">
                                                        </span>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start justify-content-between flex-wrap gap-1 mb-3">
                                                    <div class="d-flex gap-2 align-items-start flex-wrap">
                                                        <span class="avatar avatar-lg avatar-rounded bg-primary-transparent p-2">
                                                            <img src="../assets/images/company-logos/2.png" alt="Company XYZ Logo">
                                                        </span>
                                                        <div class="align-self-center">
                                                            <h6 class="fw-semibold mb-0">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start justify-content-between flex-wrap gap-1 mb-3">
                                                    <div class="d-flex gap-2 align-items-start flex-wrap">
                                                        <span class="avatar avatar-lg avatar-rounded bg-primary-transparent p-2">
                                                            <img src="../assets/images/company-logos/3.png" alt="AdminPro Logo">
                                                        </span>
                                                        <div class="align-self-center">
                                                            <h6 class="fw-semibold mb-0">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start justify-content-between flex-wrap gap-1 mb-3">
                                                    <div class="d-flex gap-2 align-items-start flex-wrap">
                                                        <span class="avatar avatar-lg avatar-rounded bg-primary-transparent p-2">
                                                            <img src="../assets/images/company-logos/5.png" alt="Creative UI Kit Logo">
                                                        </span>
                                                        <div class="align-self-center">
                                                            <h6 class="fw-semibold mb-0">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start justify-content-between flex-wrap gap-1 mb-3">
                                                    <div class="d-flex gap-2 align-items-start flex-wrap">
                                                        <span class="avatar avatar-lg avatar-rounded bg-primary-transparent p-2">
                                                            <img src="../assets/images/company-logos/6.png" alt="Minimalist UI Template Logo">
                                                        </span>
                                                        <div class="align-self-center">
                                                            <h6 class="fw-semibold mb-0">
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start justify-content-between flex-wrap gap-1 mb-3">
                                                    <div class="d-flex gap-2 align-items-start flex-wrap">
                                                        <span class="avatar avatar-lg avatar-rounded bg-primary-transparent p-2">
                                                            <img src="../assets/images/company-logos/7.png" alt="Pro UI Design System Logo">
                                                        </span>
                                                        <div class="align-self-center">
                                                            <h6 class="fw-semibold mb-0">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-40.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-40.jpg" alt="image" class="img-fluid rounded-top">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-41.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-41.jpg" alt="image" class="img-fluid rounded-top" >
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-42.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-42.jpg" alt="image" class="img-fluid rounded-top" >
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-43.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-43.jpg" alt="image" class="img-fluid rounded-top" >
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-44.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-44.jpg" alt="image" class="img-fluid rounded-top">
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                                                    <img src="../assets/images/company-logos/6.png" alt="">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-45.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-45.jpg" alt="image" class="img-fluid rounded-top">
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-46.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-46.jpg" alt="image" class="img-fluid rounded-top">
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-12">
                                                <a href="../assets/images/media/media-60.jpg" class="glightbox card search-images-card p-2" data-gallery="gallery1">
                                                    <div class="bg-light rounded">
                                                        <img src="../assets/images/media/media-60.jpg" alt="image" class="img-fluid rounded-top">
                                                        <div class="p-3 bg-light rounded-bottom">
                                                            <div class="d-flex align-items-center gap-1 flex-wrap">
                                                                <div class="avatar avatar-xs">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap gap-3">
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xl bg-info bg-opacity-25 border border-opacity-25 p-1 avatar-rounded">
                                                            <img src="../assets/images/media/books/2.jpg" alt="Book Cover">
                                                        </span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <h6 class="fw-medium mt-1 mb-2"><a href="javascript:void(0);"> Shadows of the Forgotten</a></h6>
                                                        <div class="popular-tags mb-3">
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-warning">Mystery</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-info">Thriller</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-pink">Suspense</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center flex-wrap gap-3">
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xl bg-info bg-opacity-25 border border-opacity-25 p-1 avatar-rounded">
                                                            <img src="../assets/images/media/books/3.jpg" alt="Admin Dashboard Book Cover">
                                                        </span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <h6 class="fw-medium mt-1 mb-2"><a href="javascript:void(0);"> Mastering Admin Dashboard Designs</a></h6>
                                                        <div class="popular-tags mb-3">
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-primary">Admin</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-success">Dashboard</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-secondary">Templates</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap gap-3">
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xl bg-warning bg-opacity-25 border border-opacity-25 p-1 avatar-rounded">
                                                            <img src="../assets/images/media/books/4.jpg" alt="UI Design Book Cover">
                                                        </span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <h6 class="fw-medium mt-1 mb-2"><a href="javascript:void(0);"> UI Design Fundamentals</a></h6>
                                                        <div class="popular-tags mb-3">
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-primary">UI</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-dark text-white">Design</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-success">Patterns</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex align-items-center flex-wrap gap-3">
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xl bg-danger bg-opacity-25 border border-opacity-25 p-1 avatar-rounded">
                                                            <img src="../assets/images/media/books/5.jpg" alt="Design System Book Cover">
                                                        </span>
                                                    </div>
                                                    <div class="mb-2">
                                                        <h6 class="fw-medium mt-1 mb-2"><a href="javascript:void(0);"> Design Systems: The Art of Consistency</a></h6>
                                                        <div class="popular-tags mb-3">
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-info">Design</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-secondary">System</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-success">Consistency</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center flex-wrap gap-3">
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xl bg-warning bg-opacity-25 border border-opacity-25 p-1 avatar-rounded">
                                                            <img src="../assets/images/media/books/6.jpg" alt="Responsive Admin Template Book Cover">
                                                        </span>
                                                    </div>
                                                    <div class="mb-2 px-3">
                                                        <h6 class="fw-medium mt-1 mb-2"><a href="javascript:void(0);"> Building Responsive Admin Templates</a></h6>
                                                        <div class="popular-tags mb-3">
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-primary">Responsive</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-success">Admin</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-secondary">Templates</a>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card custom-card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center flex-wrap gap-3">
                                                    <div class="mb-3">
                                                        <span class="avatar avatar-xl bg-info bg-opacity-25 border border-opacity-25 p-1 avatar-rounded">
                                                            <img src="../assets/images/media/books/1.jpg" alt="Creative UI Design Book Cover">
                                                        </span>
                                                    </div>
                                                    <div class="mb-2 px-3">
                                                        ...
                                                        <div class="popular-tags mb-3">
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-primary">UI</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-success">Design</a>
                                                            <a href="javascript:void(0);" class="badge rounded-pill bg-warning">Patterns</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="d-flex gap-2 align-items-end justify-content-between flex-wrap">
                                                    ...
                                                    <div class="ms-auto d-flex gap-2 align-items-center justify-content-end text-end flex-wrap">
                                                        ...
                                                        <span class="avatar avatar-md p-1 bg-primary bg-opacity-25 avatar-rounded flex-shrink-0">
                                                            <img src="../assets/images/faces/12.jpg" alt="Sarah Jones">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex gap-2 align-items-end justify-content-between flex-wrap">
                                                    ...
                                                    <div class="ms-auto d-flex gap-2 align-items-center justify-content-end text-end flex-wrap">
                                                        ...
                                                        <span class="avatar avatar-md p-1 bg-success bg-opacity-25 avatar-rounded flex-shrink-0">
                                                            <img src="../assets/images/faces/13.jpg" alt="James Smith">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex gap-2 align-items-end justify-content-between flex-wrap">
                                                    ...
                                                    <div class="ms-auto d-flex gap-2 align-items-center justify-content-end text-end flex-wrap">
                                                        ...
                                                        <span class="avatar avatar-md p-1 bg-info bg-opacity-25 avatar-rounded flex-shrink-0">
                                                            <img src="../assets/images/faces/14.jpg" alt="Amanda Williams">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex gap-2 align-items-end justify-content-between flex-wrap">
                                                    ...
                                                    <div class="ms-auto d-flex gap-2 align-items-center justify-content-end text-end flex-wrap">
                                                        ...
                                                        <span class="avatar avatar-md p-1 bg-warning bg-opacity-25 avatar-rounded flex-shrink-0">
                                                            <img src="../assets/images/faces/15.jpg" alt="Michael Lee">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex gap-2 align-items-end justify-content-between flex-wrap">
                                                    ...
                                                    <div class="ms-auto d-flex gap-2 align-items-center justify-content-end text-end flex-wrap">
                                                        ...
                                                        <span class="avatar avatar-md p-1 bg-info bg-opacity-25 avatar-rounded flex-shrink-0">
                                                            <img src="../assets/images/faces/16.jpg" alt="Sophia Brown">
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
