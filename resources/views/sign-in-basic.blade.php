                            ...
                            <div class="row mx-0 align-items-center">
                                <div class="col-xl-6">
                                    <div class="p-3">
                                        ...
                                        <div class="d-grid mt-4">
                                            <a href="index.html" class="btn btn-primary"><i class="ri-login-circle-line lh-1 me-2 align-middle"></i>Sign In</a>
                                        </div>
                                ...
                                <div class="col-xl-6 border rounded bg-secondary-transparent border-secondary border-opacity-10">
                                    <div class="d-flex align-items-center justify-content-around flex-column gap-4 h-100">
                                        <img src="../assets/images/authentication/5.png" alt="Sign In" class="img-fluid m-auto mb-3 flex-fill mt-4">
