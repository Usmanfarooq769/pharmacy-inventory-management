                            ...
                            <div class="row mx-0 align-items-center">
                                        ...
                                        <div class="row gy-3">
                                            ...
                                            <div class="form-check mt-3">
                                                ...
                                                <label class="form-check-label text-muted fw-normal fs-11" for="termsCheck">
                                                    ...
                                                    <a href="terms-conditions.html" class="text-success"><u>Terms & Conditions</u></a> and 
                                                    <a href="javascript:void(0);" class="text-success"><u>Privacy Policy</u></a>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="d-grid mt-3">
                                            <a href="index.html" class="btn btn-primary"><i class="ri-user-add-line lh-1 me-2 align-middle"></i>Create Account</a>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-muted mt-3 mb-0">Already have an account? <a class="text-primary fw-medium text-decoration-underline" href="sign-in-basic.html">Sign In</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 border rounded bg-secondary-transparent border-secondary border-opacity-10">
                                    <div class="d-flex align-items-center justify-content-around flex-column gap-4 h-100">
                                        <img src="../assets/images/authentication/5.png" alt="Sign Up" class="img-fluid m-auto mb-3 flex-fill mt-4">
