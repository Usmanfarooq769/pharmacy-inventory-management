                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-start gap-3 flex-wrap">
                                            ...
                                            <div class="flex-fill w-50 text-truncate">
                                                <span class="fw-medium d-block">Sophia Reed</span>
                                                <span class="d-block mb-3 text-muted fs-12 text-truncate">Reviewed the code and identified potential performance issues.</span>
                                                <div class="">
                                                    <button class="btn btn-sm btn-primary-light btn-wave waves-effect waves-light">Reply <i class="ri-reply-line ms-1"></i></button>
                                                    <button class="btn btn-sm btn-secondary-light btn-wave waves-effect waves-light">View Details <i class="ri-eye-line ms-1"></i></button>
                                                </div>
                                            </div>
                                            <div class="btn-list">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-start gap-3 flex-wrap">
                                            ...
                                            <div class="flex-fill w-50 text-truncate">
                                                ...
                                                <span class="d-block mb-3 text-muted fs-12 text-truncate">Completed initial testing of the new feature and found minor.</span>
                                                <div class="d-flex align-items-center gap-2 mb-3">
                                                    <a aria-label="anchor" href="javascript:void(0);" class="avatar avatar-md">
                                                        <img src="../assets/images/media/file-manager/1.png" alt="Document">
                                                    </a>
                                    ...
                                    <li class="list-group-item mb-1">
                                        <div class="d-flex align-items-start gap-3 flex-wrap">
                                            ...
                                            <div class="flex-fill w-50 text-truncate">
                                                ...
                                                <span class="d-block mb-3 text-muted fs-12 text-truncate">Attached the updated wireframe designs based on feedback.</span>
                                                <div class="">
                                                    <button class="btn btn-sm btn-primary-light btn-wave waves-effect waves-light">Reply <i class="ri-reply-line ms-1"></i></button>
                                                    <button class="btn btn-sm btn-secondary-light btn-wave waves-effect waves-light">View Details <i class="ri-eye-line ms-1"></i></button>
                                                </div>
                            ...
                            <div class="card-body ps-0">
                                <ul class="list-unstyled profile-timeline mb-3">
                                    <li>
                                        <div>
                                            <span class="avatar avatar-sm avatar-rounded profile-timeline-avatar">
                                                <img src="../assets/images/faces/8.jpg" alt="Emma">
                                            </span>
                                            ...
                                            <p class="profile-activity-media mb-0">
                                                <a aria-label="anchor" href="javascript:void(0);">
                                                    <img src="../assets/images/media/file-manager/4.png" alt="Wireframe Image" class="bg-light mb-0">
                                                </a>
                                    ...
                                    <li>
                                        <div>
                                            <span class="avatar avatar-sm avatar-rounded profile-timeline-avatar">
                                                <img src="../assets/images/faces/7.jpg" alt="Oliver">
                                            </span>
                                            <p class="text-muted mb-2">
                                                <span class="text-default">
                                    ...
                                    <li>
                                        <div>
                                            ...
                                            <p class="profile-activity-media mb-2">
                                                <a aria-label="anchor" href="javascript:void(0);">
                                                    <img src="../assets/images/media/media-17.jpg" alt="Plan Image" class="m-0 mt-1">
                                                </a>
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        <div>
                                            <span class="avatar avatar-sm avatar-rounded profile-timeline-avatar">
                                                <img src="../assets/images/faces/5.jpg" alt="Liam">
                                            </span>
                                            <p class="text-muted mb-2">
                                                <span class="text-default">
                                            ...
                                            <p class="text-muted mb-0 fs-12">
                                                ...
                                                <span class="avatar-list-stacked ms-2">
                                                    <span class="avatar avatar-xs avatar-rounded">
                                                        <img src="../assets/images/faces/3.jpg" alt="User 1">
                                                    </span>
                                                    <span class="avatar avatar-xs avatar-rounded">
                                                        <img src="../assets/images/faces/9.jpg" alt="User 2">
                                                    </span>
                                                    <span class="avatar avatar-xs avatar-rounded">
                                                        <img src="../assets/images/faces/12.jpg" alt="User 3">
                                                    </span>
                                                    <span class="avatar avatar-xs avatar-rounded">
                                                        <img src="../assets/images/faces/14.jpg" alt="User 4">
                                                    </span>
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked mb-1">
                                                        <span class="avatar avatar-xs avatar-rounded" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" data-bs-original-title="Simon">
                                                            <img src="../assets/images/faces/4.jpg" alt="Sony">
                                                        </span>
                                                        <span class="avatar avatar-xs avatar-rounded" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" data-bs-original-title="Sasha">
                                                            <img src="../assets/images/faces/12.jpg" alt="Vinnu">
                                                        </span>
                                                        <span class="avatar avatar-xs avatar-rounded" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-primary" data-bs-original-title="Hishen">
                                                            <img src="../assets/images/faces/6.jpg" alt="kaithi">
                                                        </span>
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex align-items-center flex-wrap gap-3">
                                            <div class="lh-1">
                                                <span class="avatar avatar-sm">
                                                    <img src="../assets/images/media/file-manager/4.png" alt="">
                                                </span>
                                            </div>
                                            <div class="flex-fill">
