                        ...
                        <div class="card custom-card bg-primary bg-opacity-005 border border-primary border-opacity-10">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-4 gap-xl-2 task-list mb-3"> 
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/2.jpg" alt="User Avatar 1">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/8.jpg" alt="User Avatar 2">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/2.jpg" alt="User Avatar 3">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +2
                                        </a>
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-4 gap-xl-2 task-list mb-3">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/4.jpg" alt="User Avatar 1">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/7.jpg" alt="User Avatar 2">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +1
                                        </a>
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-4 gap-xl-2 task-list mb-3">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/5.jpg" alt="User Avatar 1">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/9.jpg" alt="User Avatar 2">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/3.jpg" alt="User Avatar 3">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +3
                                        </a>
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-4 gap-xl-2 task-list mb-3">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/6.jpg" alt="User Avatar 1">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/3.jpg" alt="User Avatar 2">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/7.jpg" alt="User Avatar 3">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +1
                                        </a>
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-4 gap-xl-2 task-list mb-3">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/1.jpg" alt="User Avatar 1">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/5.jpg" alt="User Avatar 2">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/9.jpg" alt="User Avatar 3">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +2
                                        </a>
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-4 gap-xl-2 task-list mb-3">
                                    ...
                                    <div class="avatar-list-stacked">
                                        ...
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/10.jpg" alt="User Avatar 3">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +1
                                        </a>
                                ...
                                <div class="d-flex p-3 border rounded-4 align-items-center bg-white flex-wrap justify-content-between gap-2 task-list">
                                    ...
                                    <div class="avatar-list-stacked">
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/3.jpg" alt="User Avatar 1">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/8.jpg" alt="User Avatar 2">
                                        </span>
                                        <span class="avatar avatar-sm avatar-rounded">
                                            <img src="../assets/images/faces/5.jpg" alt="User Avatar 3">
                                        </span>
                                        <a class="avatar avatar-sm bg-primary avatar-rounded text-fixed-white" href="javascript:void(0);">
                                            +2
                                        </a>
