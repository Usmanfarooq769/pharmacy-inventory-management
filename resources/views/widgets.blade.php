                                        ...
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md p-1 bg-success-transparent avatar-rounded">
                                                    <img src="../assets/images/faces/3.jpg" alt="Team Member">
                                                </span>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md p-1 bg-warning-transparent avatar-rounded">
                                                    <img src="../assets/images/faces/4.jpg" alt="Team Member">
                                                </span>
                                            </div>
                                            <div class="flex-fill text-truncate">
                                        ...
                                        <div class="d-flex align-items-center gap-1">
                                            <div class="me-2">
                                                <span class="avatar avatar-md p-1 bg-danger-transparent avatar-rounded">
                                                    <img src="../assets/images/faces/5.jpg" alt="Team Member">
                                                </span>
                                            </div>
                                            <div class="flex-fill text-truncate">
                    ...
                    <div class="col-xxl-3">
                        <div class="custom-card card overflow-hidden">
                            <div class="p-5 bg-primary mb-5 widget-profile-bg">
                                <img src="../assets/images/faces/14.jpg" alt="" class="img-fluid rounded-circle widget-profile shadow">
                            </div>
                        ...
                        <div class="card custom-card card-style-2">
                            <div class="card-body p-0 d-flex align-items-start">
                                <div class="p-2 m-3 me-1 rounded-3 bg-primary-transparent flex-shrink-0">
                                    <img src="../assets/images/ecommerce/png/8.png" alt="img" class="img-fluid card-img-top widget-product-img avatar avatar-xl"> 
                                </div>
                                <div class="p-3 flex-grow-1 text-truncate">
                                    ...
                                    <h6 class="mt-1 mb-1 fw-semibold fs-16 text-truncate"><a href="product-details.html">Steel Electric Kettle inside copper coat</a></h6>
                                    <div class="d-flex gap-2 align-items-center flex-wrap">
                                        ...
                                        <div class="ms-auto d-flex gap-2">
                                            <a href="checkout.html" class="btn btn-icon btn-success rounded-circle">
                                                <i class="bx bx-credit-card-alt"></i>
                                            </a>
                                            <a href="cart.html" class="btn btn-icon btn-primary rounded-circle">
                                                ...
                                                <div class="d-flex align-items-center gap-3">
                                                    <div class="lh-1">
                                                        <span class="avatar avatar-md bg-secondary bg-opacity-10 p-2 avatar-rounded">
                                                            <img src="../assets/images/flags/french_flag.jpg" alt="" class="rounded-circle">
                                                        </span>
                                                    </div>
                                                    <div class="flex-fill">
                                                        <div class="d-flex mb-2 justify-content-between align-items-center">
